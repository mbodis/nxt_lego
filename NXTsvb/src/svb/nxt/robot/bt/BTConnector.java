 ...
 */
public class BTConnector extends LCPBTResponder {
     ...
     */
    public BTConnector(CommandPerformer commander) {
...
//                break;
        	...
        	// SVB my move actions	                
    		case ACTION_BUTTON:  
    			if (myCommands[ACTION_COMMAND] == null)
    				break;
	            myCommander.performCommand(ACTION_COMMAND, cmd);
	            callLCP = false;
	            break;

            // SVB setting game type 
            case GAME_TYPE:
            	if (myCommands[OUTPUT_COMMAND] == null)
                    break;
                callLCP = false;
                myCommander.performCommand(GAME_TYPE, cmd);
                break;
                
             // SVB setting robot type 
            case ROBOT_TYPE:
            	if (myCommands[OUTPUT_COMMAND] == null)
                    break;
                callLCP = false;
                myCommander.performCommand(ROBOT_TYPE, cmd);
                break;
